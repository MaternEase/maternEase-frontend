...
import { registerMother , getExpectedMothers} from '../../services/midwifeService'; // Import the registration service
...
const TABLE_HEAD = ["ID", "Name", "Age","Contact Number", "Condition", "Refer to Doctor", ""];
